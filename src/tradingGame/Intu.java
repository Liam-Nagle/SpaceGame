...
/*
 * Intu - Scarce in Rocket Fuel / Buy + Sell for more.
       	- Abundant in Carbon / Buy + Sell for less.
       	- Standard in Zera and Xerox.

 */


public class Intu extends JPanel {
	...
	public static double buyCarbonPrice = 15;
	...
	public static double buyFuelPrice = 175;
	...
	public void setBuyCarbonPrice(double buyCarbonPrice) {
		...
		Intu.buyCarbonPrice = Double.valueOf(dx);
	...
	public void setSellCarbonPrice(double sellCarbonPrice) {
		...
		Intu.sellCarbonPrice = Double.valueOf(dx);
	...
	public void setBuyZeraPrice(double buyZeraPrice) {
		...
		Intu.buyZeraPrice = Double.valueOf(dx);
	...
	public void setSellZeraPrice(double sellZeraPrice) {
		...
		Intu.sellZeraPrice = Double.valueOf(dx);
	...
	public void setBuyXeroxPrice(double buyXeroxPrice) {
		...
		Intu.buyXeroxPrice = Double.valueOf(dx);
	...
	public void setSellXeroxPrice(double sellXeroxPrice) {
		...
		Intu.sellXeroxPrice = Double.valueOf(dx);
	...
	public void setBuyFuelPrice(double buyFuelPrice) {
		...
		Intu.buyFuelPrice = Double.valueOf(dx);
	...
	public void setSellFuelPrice(double sellFuelPrice) {
		...
		Intu.sellFuelPrice = Double.valueOf(dx);
