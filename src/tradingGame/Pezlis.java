...
/*
 * Pezlis - Abundant in Zera / Buy + Sell for less
          - Scarce in Xerox and Carbon / Buy + Sell for more
          - Standard in Rocket Fuel.
 */


public class Pezlis extends JPanel {
	...
	public static double buyCarbonPrice = 19;
	public static double sellCarbonPrice = buyCarbonPrice / 1.5;
	public static double buyZeraPrice = 8;
	public static double sellZeraPrice = buyZeraPrice / 1.5;
	public static double buyXeroxPrice = 13;
	...
	public void setBuyCarbonPrice(double buyCarbonPrice) {
		...
		Pezlis.buyCarbonPrice = Double.valueOf(dx);
	...
	public void setSellCarbonPrice(double sellCarbonPrice) {
		...
		Pezlis.sellCarbonPrice = Double.valueOf(dx);
	...
	public void setBuyZeraPrice(double buyZeraPrice) {
		...
		Pezlis.buyZeraPrice = Double.valueOf(dx);
	...
	public void setSellZeraPrice(double sellZeraPrice) {
		...
		Pezlis.sellZeraPrice = Double.valueOf(dx);
	...
	public void setBuyXeroxPrice(double buyXeroxPrice) {
		...
		Pezlis.buyXeroxPrice = Double.valueOf(dx);
	...
	public void setSellXeroxPrice(double sellXeroxPrice) {
		...
		Pezlis.sellXeroxPrice = Double.valueOf(dx);
	...
	public void setBuyFuelPrice(double buyFuelPrice) {
		...
		Pezlis.buyFuelPrice = Double.valueOf(dx);
	...
	public void setSellFuelPrice(double sellFuelPrice) {
		...
		Pezlis.sellFuelPrice = Double.valueOf(dx);
