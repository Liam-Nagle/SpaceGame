...
/*
 * Elaria - No abundant or scarce resources. Default prices.

 */


public class Elaria extends JPanel {
	...
	public static double buyCarbonPrice = 17;
	...
	public void setBuyCarbonPrice(double buyCarbonPrice) {
		...
		Elaria.buyCarbonPrice = Double.valueOf(dx);
	...
	public void setSellCarbonPrice(double sellCarbonPrice) {
		...
		Elaria.sellCarbonPrice = Double.valueOf(dx);
	...
	public void setBuyZeraPrice(double buyZeraPrice) {
		...
		Elaria.buyZeraPrice = Double.valueOf(dx);
	...
	public void setSellZeraPrice(double sellZeraPrice) {
		...
		Elaria.sellZeraPrice = Double.valueOf(dx);
	...
	public void setBuyXeroxPrice(double buyXeroxPrice) {
		...
		Elaria.buyXeroxPrice = Double.valueOf(dx);
	...
	public void setSellXeroxPrice(double sellXeroxPrice) {
		...
		Elaria.sellXeroxPrice = Double.valueOf(dx);
	...
	public void setBuyFuelPrice(double buyFuelPrice) {
		...
		Elaria.buyFuelPrice = Double.valueOf(dx);
	...
	public void setSellFuelPrice(double sellFuelPrice) {
		...
		Elaria.sellFuelPrice = Double.valueOf(dx);
